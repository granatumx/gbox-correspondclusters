> `gbox-correspondclusters` is a gbox that provides an ability to correspond clusters from a clustering algorithm to ground truth eliminating cells that are incorrectly clustered
...
$ gx installGbox.sh granatumx/gbox-correspondclusters:1.0.0  # Install this gbox
